...
import InventoryDetailsClient from "./inventory-details-client";

export const metadata = {
  title: "Inventaire — Stock",
};

export default async function StockInventoryDetailsPage({
  params,
}: {
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
            Document d’inventaire : génération des lignes, comptage, puis clôture.
          </p>
        </div>
