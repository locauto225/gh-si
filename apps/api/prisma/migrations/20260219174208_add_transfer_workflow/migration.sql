...
INSERT INTO "new_Warehouse" ("address", "code", "createdAt", "deletedAt", "id", "isActive", "kind", "name", "priceListId", "updatedAt") SELECT "address", "code", "createdAt", "deletedAt", "id", "isActive", "kind", "name", "priceListId", "updatedAt" FROM "Warehouse";
DROP TABLE "Warehouse";
ALTER TABLE "new_Warehouse" RENAME TO "Warehouse";
CREATE UNIQUE INDEX "Warehouse_code_key" ON "Warehouse"("code");
CREATE INDEX "Warehouse_kind_idx" ON "Warehouse"("kind");
CREATE INDEX "Warehouse_isSystem_idx" ON "Warehouse"("isSystem");
